...
<html lang="en">
    ...
    <!-- <link rel="stylesheet" href="<?php echo HResponse::uri(); ?>/css/font-awesome.min.css" /> -->
    <link href="http://cdn.staticfile.org/font-awesome/3.2.1/css/font-awesome.min.css" rel="stylesheet">
    <!--[if IE 7]>
      <!-- <link rel="stylesheet" href="<?php echo HResponse::uri(); ?>/css/font-awesome-ie7.min.css" /> -->
      <link href="http://cdn.staticfile.org/font-awesome/3.2.1/css/font-awesome-ie7.min.css" rel="stylesheet">
    <![endif]-->
    <!-- ace styles -->
    <link rel="stylesheet" href="<?php echo HResponse::uri(); ?>/css/ace.min.css" />
