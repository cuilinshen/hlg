...
<?php $field = 'shortname'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'name'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'merger_name'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'level'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'pinyin'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'code'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'zip_code'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'first'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'lng'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'lat'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
