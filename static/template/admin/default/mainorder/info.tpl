...
<?php $field = 'pay_id'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'pay_status'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'qishou_money'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'pay_time'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
