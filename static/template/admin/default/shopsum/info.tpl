...
<?php $field = 'cur_visits'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'cur_collects'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'cur_comments'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'cur_date'; require(HResponse::path('admin') . '/fields/date.tpl'); ?>
