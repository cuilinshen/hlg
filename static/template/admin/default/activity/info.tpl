...
<?php $field = 'max'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'min'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'total_num'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'level_num'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'start_time'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'end_time'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'product_id'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'company_id'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
