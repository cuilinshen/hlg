...
<?php $field = 'money'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'order_id'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'order_code'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
