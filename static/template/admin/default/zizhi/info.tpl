                        ...
                        <form action="<?php echo HResponse::url($modelEnName . '/' . HResponse::getAttribute('nextAction') ); ?>" method="post" enctype="multipart/form-data" id="info-form">
                            <div class="row-fluid">
                                ...
                                <!-- PAGE CONTENT BEGINS HERE -->
                                    ...
                                    <?php $field = 'user_name'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'parent_id'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'user_icard'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'face_image'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'licence_name'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'image_path'; require(HResponse::path('admin') . '/fields/file.tpl'); ?>
<?php $field = 'licence_number'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'licence_address'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'licence_type'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'licence_time'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
