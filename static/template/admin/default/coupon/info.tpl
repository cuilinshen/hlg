...
<?php $field = 'song'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
...
<?php $field = 'start_time'; require(HResponse::path('admin') . '/fields/date.tpl'); ?>
<?php $field = 'end_time'; require(HResponse::path('admin') . '/fields/date.tpl'); ?>
<?php $field = 'company_id'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'product_id'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
