...
<?php $field = 'total_money'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'total_orders'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'yes_orders'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'area'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'total_score'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
