...
<?php $field = 'faren_name'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'faren_card'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'faren_phone'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'type'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'anbao_name'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'anbao_phone'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'card'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'xingzhi'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'biaoshi'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'cause'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'write_id'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'write_time'; require(HResponse::path('admin') . '/fields/date.tpl'); ?>
<?php $field = 'checked_id'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'checked_time'; require(HResponse::path('admin') . '/fields/date.tpl'); ?>
