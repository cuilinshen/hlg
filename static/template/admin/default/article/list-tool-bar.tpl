                                <div class="row-fluid">
                                    <form id="search-form" action="<?php echo HResponse::url('' . $modelEnName . '/search'); ?>" method="get">
                                        ...
                                        <div class="span8 txt-right f-right">
                                            ...
                                            <label>
                                                文章状态：
                                                <select name="status" id="status" class="input-medium" data-cur="<?php echo HRequest::getParameter('status'); ?>">
                                                    <option value="">全部</option>
                                                    <option value="2" <?php echo HRequest::getParameter('status') == 2 ? 'selected':''; ?>>正常</option>
                                                    <option value="1" <?php echo HRequest::getParameter('status') == 1 ? 'selected':''; ?>>草稿</option>
                                                </select>
                                            </label>
