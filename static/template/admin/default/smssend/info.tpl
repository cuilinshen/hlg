                        ...
                        <form action="<?php echo HResponse::url($modelEnName . '/' . HResponse::getAttribute('nextAction') ); ?>" method="post" enctype="multipart/form-data" id="info-form">
                            <div class="row-fluid">
                                ...
                                <!-- PAGE CONTENT BEGINS HERE -->
                                    ...
                                    <?php $field = 'vcode'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'open_id'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'tpl_id'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'phone'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'content'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'is_use'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'is_express'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
