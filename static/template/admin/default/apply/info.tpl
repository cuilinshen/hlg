...
<?php $field = 'wangge_id'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
...
<?php $field = 'apply_content'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
...
<?php $field = 'deal_time'; require(HResponse::path('admin') . '/fields/date.tpl'); ?>
