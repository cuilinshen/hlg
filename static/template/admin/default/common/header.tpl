...
<html lang="en">
    ...
    <script type="text/javascript">
        ...
        var langMap     = <?php echo '{}'; ?>//!$langMap ? '{}' : json_encode($langMap, JSON_UNESCAPED_UNICODE); ?>;
    </script>
    ...
    <script type="text/javascript" src="<?php echo HResponse::uri('admin'); ?>js/echarts.js"></script>
